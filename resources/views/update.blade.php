    ...
    <div class="row">
        <form id="cat_form" method="POST" type="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="type" class="form-control" id="cat_name" name="category" placeholder="Category Name" value="" >
            </div>
            <div class="mb-3">
            ...
            <input class="form-control" type="hidden" id="cat_id" name="cat_id">
            <button type="submit" class="btn btn-primary" id="cat_submit">Update</button>
        </form>
